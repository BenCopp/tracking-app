                          ...
                          {exSearch ? (
                            ...
                            <div className="space-y-4">
                              <button 
                                onClick={() => {
                                  const newExData = { 
                                    name: `NEW EXERCISE ${currentPlan.exerciseIds.length + 1}`,
                                    category: 'Custom' 
                                  };
                                  if (auth.currentUser) {
                                    addDocument('exercise_templates', newExData).then(id => {
                                ...
                                className="w-full p-4 bg-[#3B82F6] rounded-xl text-white text-[10px] font-mono uppercase font-bold text-center hover:bg-[#3B82F6]/90 transition-all shadow-lg shadow-blue-500/20"
                              >
                                + QUICK ADD NEW NODE
                              </button>
